...
\section{Class of 01/03/2024 - Kruskal's algorithm}
...
This is very similar to Dijkstra's algorithm, but we are keeping track on how to get from one vertex to another instead of just the distance.
