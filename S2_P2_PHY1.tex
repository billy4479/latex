...
The divergence indicates how much the vector field is going \say{into} a certain point or how much is it going \say{out} of it.

\begin{figure}[H]
    \centering
    \includesvg[width=0.5\textwidth]{assets/S2_P2_PHY1/divergence.svg}
...
\begin{theorem}[Bernoulli equation]
