...
\begin{figure}[H]
    ...
    \subfloat[\centering Image]{{
                \includegraphics[width=0.35\textwidth]{assets/S2_P1_AN2/ordinary_cusp_image.png}
            }}
    \subfloat[\centering Graph]{{
                \includegraphics[width=0.35\textwidth]{assets/S2_P1_AN2/ordinary_cusp_graph.png}
            }}
...
\begin{figure}[H]
    ...
    \subfloat[\centering Inflection point]{{
                \includegraphics[width=0.35\textwidth]{assets/S2_P1_AN2/inflection_point.png}
            }}
    \subfloat[\centering Ordinary cusp]{{
                \includegraphics[width=0.35\textwidth]{assets/S2_P1_AN2/ordinary_cusp.png}
            }}
