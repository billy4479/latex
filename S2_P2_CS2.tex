...
We will use the notation $A \reducesto B$ to say that \say{$A$ reduces to $B$}. This is saying that $A$ is not more difficult than $B$.
...
\begin{theorem}[circuits can simulate algorithms]
...
\begin{proof}
    ...
    \phantom{)} % Hack: in this way the syntax highlighting is happy
\end{proof}
