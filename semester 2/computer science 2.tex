...
Usually we don't use limits to prove that a sequence is big O of another, it is usually more convenient to procede by inequalities.
...
We can aslo define the expected result $E(X)$ of the experiment as
$$
...
The number is interpreded according to the following formula:
