...
Consider a cylinder of base area $A$ and height $ \varepsilon \ll 1$ inside a general surface $S$ of constant charge distribution $\sigma$.

\begin{equation}
    \oint_S \vec E \cdot \dd{\vec S} = \frac{Q_\text{enc}}{\varepsilon_0} = \frac{\sigma A}{\varepsilon_0} = \underbrace{\cancel{\int_{S_\text{lat}} \vec E \cdot \dd{\vec S}}}_{\propto \varepsilon} + \int_{S_\text{top}} E \cos \theta \cdot \dd{S} + \int_{S_\text{bottom}} E \cos \theta' \cdot \dd{\vec S}
\end{equation}
