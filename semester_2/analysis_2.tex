...
\begin{itemize}
    ...
    \item If $\munderbar{F} = \triangledown g$ (with $g: \R^2 \to \R$) is the gradient of a potential $g$, then $\int_\gamma \munderbar{F} \cdot \dd{\munderbar{s}} = \int_\gamma \triangledown g \cdot \dd{\munderbar{s}} = g(\gamma(b)) - g(\gamma(a))$.

          If $g = g(x, y)$ then we have that $\triangledown g = \begin{pmatrix}
