...
\newcommand{\convdist}{\stackrel{\text{d}}{\to}}
\newcommand{\convprob}{\stackrel{\text{P}}{\to}}
...
\begin{theorem}[Chebyshev inequality]
    Let $\mu = E(X)$ and apply \autoref{thm:mgf:markuo} with $r = 2$:
    \begin{equation}
...
\begin{equation}
    P(\exists n \geq 1 : \forall k \geq n \abs{X_k - X} \leq \varepsilon) = 1
\end{equation}
which is equivalent to
\begin{equation}
    P\left( \bigcup_{n = 1}^\infty \bigcap_{k = n}^\infty \left(\abs{X_n - X} \leq \varepsilon\right) \right) = 1
\end{equation}
...
\begin{theorem}
    ...
    \begin{enumerate}
        \item \begin{equation}
              ...
              \end{equation}
        \item If $(\abs{X_n - X} > \varepsilon) \indep$ then
              \begin{equation}
                  X_n \convas X \iff \sum_{n = 1}^\infty P(\abs{X_n - X} > \varepsilon)
              \end{equation}
    \end{enumerate}
\end{theorem}
